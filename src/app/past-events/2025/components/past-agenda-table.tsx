...
export const extractBreakout = (description: string) => {
...
const secondDayViewMoreSessions: Session[] = [
  ...
  {
    time: "13:15 – 13:45",
    title: "Why Ignoring QA is Costing You.",
    description:
      "by June Katei Reeves | Breakout: Talk: Reinvention and the Courage to Pivot in Tech by Sarah Muwanguzi",
  ...
  },
  {
    ...
    description:
      "(Moderator: Tima Ali) | Breakout: Talk: From Engineer to Change-Maker – AI for Community Health by Alice  Wangeci",
...
const PastAgendaTable: React.FC<AgendaTableProps> = ({
...
export default PastAgendaTable;
